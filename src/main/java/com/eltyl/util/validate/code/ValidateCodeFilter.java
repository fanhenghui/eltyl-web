...
import com.eltyl.config.MyAuthenticationFailureHandler;
import com.eltyl.properties.SecurityConstants;
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean{
    ...
    private ValidateCodeType getValidateCodeType(HttpServletRequest request) {
        ...
        if (!StringUtils.equalsIgnoreCase(request.getMethod(), "get")) {//不是get请求
